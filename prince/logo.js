const { gmd, gmdBuffer, getContextInfo } = require("../mayel");
  ...
  gmd(
    ...
    async (from, Prince, conText) => {
      ...
      try {
        ...
        const apiUrl = `${PrinceTechApi}/api/ephoto360/${config.endpoint}?apikey=${PrinceApiKey}&text=${encodeURIComponent(q)}`;
        ...
        const contextInfo = getContextInfo(sender);
